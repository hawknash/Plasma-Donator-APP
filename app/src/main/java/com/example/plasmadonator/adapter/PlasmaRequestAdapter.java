package com.example.plasmadonator.adapter;
...
public class PlasmaRequestAdapter extends RecyclerView.Adapter<PlasmaRequestAdapter.PostHolder> {
    ...
    public PlasmaRequestAdapter(List<CustomUserData> postLists)
    {
