...
public class RequestPlasma extends AppCompatActivity {
    ...
    EditText text1, text2,spinner1,spinner2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null){
            getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.backgorund));}
        ...
        spinner1 = findViewById(R.id.bloodgroup);
        ...
        if(cur_user == null)
        {
            startActivity(new Intent(RequestPlasma.this, LoginActivity.class));
        } else {
            uid = cur_user.getUid();
        }
                        ...
                        findname.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    db_ref.child(uid).child("Division").setValue(spinner2.getText().toString());
                                    db_ref.child(uid).child("BloodGroup").setValue(spinner1.getText().toString());
                                    db_ref.child(uid).child("Time").setValue(Time);
                                    db_ref.child(uid).child("Date").setValue(Date);
                                    Toast.makeText(RequestPlasma.this, "Your post has been created successfully",
                                            Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(RequestPlasma.this, Dashboard.class));
